...
export const FIX_CONFIDENCE: Record<string, number> = {
  ...
  'link-name': 0.8, // Infers from href, may need adjustment
  'input-button-name': 0.9, // Simple value addition
  ...
  'autocomplete-valid': 0.8, // Map-based, may not match all cases
  'form-field-multiple-labels': 0.5, // Just a comment, needs manual work

  // === DOCUMENT STRUCTURE ===
  'html-has-lang': 0.99, // Trivial fix, very reliable
  'document-title': 0.9, // Simple addition but needs real title
  'meta-viewport': 0.95, // Regex replacement is reliable

  // === HEADING STRUCTURE ===
  'heading-order': 0.65, // Suggests h2, but context-dependent
  'empty-heading': 0.7, // Adds placeholder, needs real content

  // === LANDMARKS ===
  'landmark-one-main': 0.75, // Wrapping is correct but may affect layout
  region: 0.8, // Simple role addition
  bypass: 0.6, // Adds skip link template, needs integration

  // === TABLES ===
  'td-headers-attr': 0.7, // Adds placeholder, needs real header IDs
  'th-has-data-cells': 0.85, // Scope addition is usually correct

  // === ARIA ===
  'aria-required-children': 0.65, // Complex, depends on content structure
  'aria-required-parent': 0.7, // Wrapping may affect layout
  'aria-hidden-focus': 0.9, // Tabindex fix is straightforward
  ...
  // === LISTS ===
  list: 0.7, // Wrapping may affect layout
  listitem: 0.7, // Wrapping may affect layout

  // === IFRAMES ===
  'frame-title': 0.9, // Infers from src, usually good
  'frame-focusable-content': 0.85, // Simple tabindex addition

  // === COLOR AND CONTRAST ===
  'color-contrast': 0.5, // Just a comment, needs manual work
  'link-in-text-block': 0.8, // Adds underline style
  ...
  // === SCROLLABLE REGIONS ===
  'scrollable-region-focusable': 0.9, // Simple tabindex addition

  // === VIDEO/AUDIO ===
  'video-caption': 0.6, // Adds template, needs real captions file
  'audio-caption': 0.5, // Just a comment, needs transcript
}
