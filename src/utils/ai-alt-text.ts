...
Return ONLY the alt text, nothing else.`
  ...
  const finalAltText =
    altText.length > maxLength ? altText.slice(0, maxLength - 3) + '...' : altText
 ...
 */
export function inferImageContext(imagePath: string, surroundingHtml?: string): string | undefined {
