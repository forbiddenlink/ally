...
const BUSINESS_REASONING: Record<string, string> = {
  'button-name':
    'Users cannot activate buttons, blocking core actions like "Submit", "Buy Now", or "Sign Up"',
  ...
  'image-alt':
    'Users miss critical visual information, including product images, diagrams, or icons',
  ...
  'heading-order':
    'Page structure is confusing, making content difficult to navigate and understand',
 ...
 */
export function calculateImpactScore(violation: Violation, context: PageContext = {}): ImpactScore {
  ...
  const reasoning =
    BUSINESS_REASONING[violationId] ||
